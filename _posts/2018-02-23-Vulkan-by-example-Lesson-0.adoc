...
===== Conclusion
Wow, the whole post and no any single `Vulkan` related line of code! Sorry, that was a long indroduction but I promise the next lesson will be much more interesting.