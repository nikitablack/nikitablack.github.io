...
That's basically it - we have a program and we need to make gpu run it. All other code are just instructions to the gpu to use correct stages, correct data etc.
