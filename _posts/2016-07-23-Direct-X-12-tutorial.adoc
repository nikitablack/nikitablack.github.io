...
image::teapot_tutorial/shader_res_1.png[Shader Resources, 800, 524, link="https://raw.githubusercontent.com/nikitablack/nikitablack.github.io/master/images/teapot_tutorial/shader_res_1.png"]
