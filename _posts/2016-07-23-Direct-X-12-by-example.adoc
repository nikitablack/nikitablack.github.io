...
Finally no more new interfaces! Actually there's one - `ID3D12Debug`. You should always use it in debug run. During an error it writes to the output the reason.