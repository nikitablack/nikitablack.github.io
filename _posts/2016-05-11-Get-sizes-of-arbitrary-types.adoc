...
After I posted an article I reseived a very constructive feedback and fixes to my post. In simple words - all I wrote is a bullshit. The same can be achieved much easier. For example funcion `assign()` can be rewriten as:
