...
===== Disclaimer!
I'm not an expert, computer graphics is my hobby. Thought when I started to learn `directx 12` I already was quite comfortable with `directx 11` it was still difficult to switch. And even after several months of investigations I still have a feeling that I just scratched a surface. I'm still learning and this post is a syncronization of my thoughts. I found that attempts to explain complex things makes me understand things better. Thought the artile was written by me for me I hope somebody will find it useful too.
...
https://www.youtube.com/watch?v=m5Lac8TNsc0[Here's] the result of the work we have done. And https://github.com/nikitablack/directx-12/tree/master/TeapotTutorial/TeapotTutorial[here] is the full source.