...
.. And the last one thing to do for now is to check if required extensions are supported by the selected device. Remember, in https://TODO[previous lesson] I mentioned some extensions we need for sure - 
