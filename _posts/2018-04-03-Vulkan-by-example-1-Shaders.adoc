...
Next is https://github.com/nikitablack/vulkan_by_example_2/blob/lesson_1/src/teapot/src/vulkan/create_surface.cpp[create_survace] function. Here again we use `glfw` to obtain a platform dependent object.
