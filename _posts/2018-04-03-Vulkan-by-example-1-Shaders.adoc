...
Next we tell the GPU that this stage produces 16 control points for the patch, i.e. doesn't changes the amount (yes, this stage can generate new points as well as remove some).
