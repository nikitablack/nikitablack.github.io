...
++++
<details>
<summary>Some long text summarised</summary>
<pre>
<code>AppData prepare_device_features(AppData data)
{
	data.physicalDeviceFeatures.tessellationShader = VK_TRUE; // #a
	data.physicalDeviceFeatures.fillModeNonSolid = VK_TRUE;  // #b
