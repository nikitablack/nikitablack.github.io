...
The data, presented in the set have to be repeated - the body part have to be rotated 3 more times and the handle with the spout have to be mirrored. I just added additional indices - the copy of corresponding parts (so I can use single index array without instancing) and introduced additional array of transformations. Later, in shaders  
